...
public class GrayWoolSaplingBlock extends WoolTreesModElements.ModElement {
	@ObjectHolder("wool_trees:gray_wool_sapling")
	public static final Block block = null;

	public GrayWoolSaplingBlock(WoolTreesModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gray_wool_sapling");
		}
