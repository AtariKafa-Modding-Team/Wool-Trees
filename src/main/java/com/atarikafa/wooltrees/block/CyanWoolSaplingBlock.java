...
public class CyanWoolSaplingBlock extends WoolTreesModElements.ModElement {
	@ObjectHolder("wool_trees:cyan_wool_sapling")
	public static final Block block = null;

	public CyanWoolSaplingBlock(WoolTreesModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cyan_wool_sapling");
		}
