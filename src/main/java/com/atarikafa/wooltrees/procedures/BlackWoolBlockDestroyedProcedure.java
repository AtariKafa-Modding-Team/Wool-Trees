	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WoolTreesMod.LOGGER.warn("Failed to load dependency world for procedure BlackWoolBlockDestroyed!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WoolTreesMod.LOGGER.warn("Failed to load dependency x for procedure BlackWoolBlockDestroyed!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WoolTreesMod.LOGGER.warn("Failed to load dependency y for procedure BlackWoolBlockDestroyed!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WoolTreesMod.LOGGER.warn("Failed to load dependency z for procedure BlackWoolBlockDestroyed!");
			return;
		}
