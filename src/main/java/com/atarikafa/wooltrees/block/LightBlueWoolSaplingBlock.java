...
public class LightBlueWoolSaplingBlock extends WoolTreesModElements.ModElement {
	@ObjectHolder("wool_trees:light_blue_wool_sapling")
	public static final Block block = null;

	public LightBlueWoolSaplingBlock(WoolTreesModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("light_blue_wool_sapling");
		}
