...
public class LimeWoolSaplingBlock extends WoolTreesModElements.ModElement {
	@ObjectHolder("wool_trees:lime_wool_sapling")
	public static final Block block = null;

	public LimeWoolSaplingBlock(WoolTreesModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lime_wool_sapling");
		}
