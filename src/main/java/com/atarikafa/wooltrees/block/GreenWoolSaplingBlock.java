...
public class GreenWoolSaplingBlock extends WoolTreesModElements.ModElement {
	@ObjectHolder("wool_trees:green_wool_sapling")
	public static final Block block = null;

	public GreenWoolSaplingBlock(WoolTreesModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_wool_sapling");
		}
