...
public class BrownWoolSaplingBlock extends WoolTreesModElements.ModElement {
	@ObjectHolder("wool_trees:brown_wool_sapling")
	public static final Block block = null;

	public BrownWoolSaplingBlock(WoolTreesModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brown_wool_sapling");
		}
