...
public class WhiteWoolBlock extends WoolTreesModElements.ModElement {
	@ObjectHolder("wool_trees:white_wool")
	public static final Block block = null;

	public WhiteWoolBlock(WoolTreesModElements instance) {
		super(instance, 5);
	}
